...
public class OnlineLibraryManagement {
	    ...
	    public HashMap<Integer,String> book_database_server()
	    {
	        ...
	        map.put(7,"EE : Microprocessor");
	        map.put(8,"ECE : Basic Electronics");
	        map.put(9,"ECE : Microprocessor & Microcontroller");
	        map.put(10,"CSE :Python Programming");
	        map.put(11,"CSE :Cpp Programming");
	        ...
	        map.put(22,"MATHS : Descrite Mathematics-1");
	        map.put(23,"MATHS : Algebra");
	        map.put(24,"PHYS : Physics");
	        map.put(25,"CHEM : Chemistry");
	        map.put(26,"ENG : English");
	        map.put(27,"EE : Control System");
	        map.put(38,"EE : Electrical Circuit Theory");
	        map.put(29,"EE : Electric & Hybrid Vehicle");
	    ...
	    public void admin_login()
	    {
	        ...
	        loginto.put("Aishwarya",12345);
	        loginto.put("Priya",20026);
	    ...
	    public void user_login()
	    {
	        ...
	        System.out.print("Enter Password: ");
	        int password = sc.nextInt();
	        loginto.put("Aishwarya",13579);
	        loginto.put("Priya",20026);
	        loginto.put("Sachi",12345);
	        loginto.put("Gita",24680);
	        loginto.put("Diya",11111);
	    ...
	    {
	        System.out.println("--------------------------------------------------------");
	        System.out.println("----- Digital Library ---> Welcome Admin " + OnlineLibraryManagement.userID + "! ----");
	    ...
	    {
	        System.out.println("--------------------------------------------------------");
	        System.out.println("----- Digital Library ---> Welcome User " + OnlineLibraryManagement.userID + "! -----");
	    ...
	    public static void main(String args[]){
	    	OnlineLibraryManagement system_run = new OnlineLibraryManagement();
	        system_run.homepage();
	    }
	}
